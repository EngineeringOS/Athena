...
/** Provenance captured for one authored span that contributed to a canonical IR object. */
...
/** Root canonical engineering document emitted by the lowering boundary. */
data class EngineeringIrDocument(
