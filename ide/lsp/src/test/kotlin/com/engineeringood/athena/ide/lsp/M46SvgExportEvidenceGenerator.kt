...
fun main(args: Array<String>) {
    ...
    try {
        ...
        require(first == second) { "Repeated M46 SVG export is not deterministic." }

        val exportRoot = root.resolve("_bmad-output/implementation-artifacts/m46/exports")
        Files.createDirectories(exportRoot)
        Files.writeString(exportRoot.resolve("m46-rolling-shutter.svg"), first)
    } finally {
        host.shutdown()
    }
}
