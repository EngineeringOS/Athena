...
data class AthenaSemanticReviewPayload(
    ...
    val engineeringImpactConsequences: List<AthenaEngineeringImpactConsequencePayload>,
    val entryCount: Int,
...
internal fun SemanticReviewSummary.toPayload(): AthenaSemanticReviewPayload {
    return AthenaSemanticReviewPayload(
        ...
        engineeringImpactConsequences = engineeringImpactConsequences.consequences.map { consequence -> consequence.toPayload() },
