...
let AthenaRepositoryGraphWidget = class AthenaRepositoryGraphWidget extends react_widget_1.ReactWidget {
    ...
    render() {
        ...
        return React.createElement("div", { className: 'athena-repository-graph' },
            ...
            React.createElement("section", { className: 'athena-repository-graph__summary' },
                React.createElement("ul", { className: 'athena-repository-graph__summary-list' },
                    React.createElement("li", null,
                        React.createElement("span", null, "Resolved packages"),
                        React.createElement("strong", null, graphSession.resolvedPackages.length)),
                    React.createElement("li", null,
                        React.createElement("span", null, "Manifest dependencies"),
                        React.createElement("strong", null, graphSession.manifestDependencies.length)),
                    React.createElement("li", null,
                        React.createElement("span", null, "Package diagnostics"),
                        React.createElement("strong", null, graphSession.diagnostics.length)),
                    React.createElement("li", null,
                        React.createElement("span", null, "Lock state"),
                        React.createElement("strong", null, graphSession.lockState)))),
            React.createElement("section", { className: 'athena-repository-graph__section' },
                React.createElement("h3", null, "Repository contract"),
                React.createElement("ul", { className: 'athena-repository-graph__detail-list' },
                    React.createElement("li", null,
                        React.createElement("span", null, "Manifest"),
                    ...
                    React.createElement("li", null,
                        React.createElement("span", null, "Governed source root"),
                        React.createElement("strong", null,
                            React.createElement("code", null, graphSession.sourceRootPath))),
                    React.createElement("li", null,
                        React.createElement("span", null, "Authored source"),
                        React.createElement("strong", null,
                            React.createElement("code", null, graphSession.sourcePath))),
                    React.createElement("li", null,
                        React.createElement("span", null, "Project key"),
                        React.createElement("strong", null, graphSession.projectName)),
                    React.createElement("li", null,
                        React.createElement("span", null, "Semantic path"),
                        React.createElement("strong", null, graphSession.semanticPath)),
                    React.createElement("li", null,
                        React.createElement("span", null, "Last Athena editor"),
                        React.createElement("strong", null, graphSession.lastOpenedDocumentUri ?? 'Not opened yet')),
                    React.createElement("li", null,
                        React.createElement("span", null, "Lock status"),
                        React.createElement("strong", null,
    ...
    renderDependency(dependency) {
        ...
        return React.createElement("li", { key: `${dependency.name}:${dependency.source}:${dependencyTarget}`, className: 'athena-repository-graph__item' },
            React.createElement("span", { className: 'athena-repository-graph__item-title' }, dependency.name),
            React.createElement("span", { className: 'athena-repository-graph__item-meta' },
                dependency.source,
                " | ",
                dependencyTarget));
    }
    renderResolvedPackage(resolvedPackage) {
        ...
        return React.createElement("li", { key: `${resolvedPackage.name}:${resolvedPackage.sourceRoot}`, className: 'athena-repository-graph__item' },
            React.createElement("span", { className: 'athena-repository-graph__item-title' }, packageLabel),
            React.createElement("span", { className: 'athena-repository-graph__item-meta' },
                React.createElement("code", null, resolvedPackage.sourceRoot)),
            React.createElement("span", { className: 'athena-repository-graph__item-meta' }, dependencies));
    }
