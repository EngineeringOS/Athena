...
let AthenaHomeWidget = class AthenaHomeWidget extends react_widget_1.ReactWidget {
    ...
    render() {
        ...
        return React.createElement("div", { className: 'athena-home' },
            ...
            React.createElement("section", { className: 'athena-home__intro' },
                ...
                React.createElement("p", null,
                    ...
                    ".")),
            React.createElement("section", { className: 'athena-home__toolbar' },
            ...
            React.createElement("section", { className: 'athena-home__layout' },
                React.createElement("article", { className: 'athena-home__panel' },
                    React.createElement("div", { className: 'athena-home__panel-header' },
                        React.createElement("h2", null, "Current proof")),
                    React.createElement("ul", { className: 'athena-home__dense-list' },
                ...
                React.createElement("article", { className: 'athena-home__panel' },
                    ...
                    React.createElement("p", { className: 'athena-home__panel-lead' }, sessionState.message),
                    React.createElement("ul", { className: 'athena-home__kv-list' }, sessionRows.map(row => React.createElement("li", { key: row.key },
                        React.createElement("span", { className: 'athena-home__kv-key' }, row.label),
                        React.createElement("strong", { className: 'athena-home__kv-value' }, row.value))))),
                React.createElement("article", { className: 'athena-home__panel athena-home__panel--wide' },
                    React.createElement("div", { className: 'athena-home__panel-header' },
                        React.createElement("h2", null, "Workbench views")),
                    React.createElement("p", { className: 'athena-home__panel-lead' }, "Athena workbench additions attach through one product-owned extension registry, so later milestones can add panels without replacing the shell."),
                    React.createElement("div", { className: 'athena-home__toolbar athena-home__toolbar--panel' },
                ...
                React.createElement("article", { className: 'athena-home__panel athena-home__panel--wide' },
                    ...
                    React.createElement("ul", { className: 'athena-home__dense-list' },
                        React.createElement("li", null, "This shell now carries the M6 operability essentials on top of the M4 and M5 base: editing, completion, document symbols, go-to-definition, references, diagnostics in Problems and editor markers, repository navigation, package-graph feedback, semantic review and commit-preparation projection, output panels, terminal visibility, and product-owned workbench framing."),
                        React.createElement("li", null, "Marketplace sprawl, semantic history publishing, and graphical projection tooling remain intentionally deferred."))),
                React.createElement("article", { className: 'athena-home__panel athena-home__panel--wide' },
                    React.createElement("div", { className: 'athena-home__panel-header' },
                        React.createElement("h2", null, "Current repository rule")),
                    React.createElement("ul", { className: 'athena-home__kv-list' },
                        React.createElement("li", null,
                            React.createElement("span", { className: 'athena-home__kv-key' }, "Contract"),
                            React.createElement("strong", { className: 'athena-home__kv-value' },
                                "Athena validates ",
                                ...
                                " layout through the JVM stack.")),
                        React.createElement("li", null,
                            React.createElement("span", { className: 'athena-home__kv-key' }, "Editor seed"),
                            React.createElement("strong", { className: 'athena-home__kv-value' }, "The runtime derives one deterministic authored source as the temporary editor seed for the active session.")),
                        React.createElement("li", null,
                            React.createElement("span", { className: 'athena-home__kv-key' }, "Repository meaning"),
                            React.createElement("strong", { className: 'athena-home__kv-value' }, "The active package graph is inspectable through the dedicated Repository Graph workbench view rather than a single-file shortcut."))))));
    }
};
