...
fun siemensElectricalPartImplementations(): List<PartImplementationDefinition> {
    return listOf(
        PartImplementationDefinition(
            implementationId = PartImplementationId("impl/electrical/plc-cpu/siemens-evidence-cpu313c"),
            conceptId = EngineeringConceptId("electrical.plc.cpu"),
            vendorId = VendorId("siemens"),
            vendorPartNumber = VendorPartNumber("evidence.cpu.313c"),
            displayName = "Siemens evidence PLC CPU 313C",
            summary = "Narrow Siemens-first evidence implementation for the PLC CPU concept.",
        ),
        PartImplementationDefinition(
            implementationId = PartImplementationId("impl/electrical/plc-cpu/siemens-evidence-cpu314c"),
            conceptId = EngineeringConceptId("electrical.plc.cpu"),
            vendorId = VendorId("siemens"),
            vendorPartNumber = VendorPartNumber("evidence.cpu.314c"),
            displayName = "Siemens evidence PLC CPU 314C",
            summary = "Alternate Siemens-first evidence implementation for governed PLC CPU selection flows.",
        ),
        PartImplementationDefinition(
            implementationId = PartImplementationId("impl/electrical/contactor/siemens-evidence-3pole"),
            conceptId = EngineeringConceptId("electrical.contactor.power"),
            vendorId = VendorId("siemens"),
            vendorPartNumber = VendorPartNumber("evidence.contactor.3pole"),
            displayName = "Siemens evidence power contactor",
            summary = "Narrow Siemens-first evidence implementation for the power contactor concept.",
        ),
        PartImplementationDefinition(
            implementationId = PartImplementationId("impl/electrical/relay/siemens-evidence-overload"),
            conceptId = EngineeringConceptId("electrical.relay.overload"),
            vendorId = VendorId("siemens"),
            vendorPartNumber = VendorPartNumber("evidence.relay.overload"),
            displayName = "Siemens evidence overload relay",
            summary = "Narrow Siemens-first evidence implementation for the overload relay concept.",
        ),
        PartImplementationDefinition(
            implementationId = PartImplementationId("impl/electrical/motor/siemens-evidence-ac-motor"),
            conceptId = EngineeringConceptId("electrical.motor.ac"),
            vendorId = VendorId("siemens"),
            vendorPartNumber = VendorPartNumber("evidence.motor.ac"),
            displayName = "Siemens evidence AC motor",
            summary = "Narrow Siemens-first evidence implementation for the AC motor concept.",
        ),
        PartImplementationDefinition(
            implementationId = PartImplementationId("impl/electrical/power-supply/siemens-evidence-24vdc"),
            conceptId = EngineeringConceptId("electrical.power-supply.dc24"),
            vendorId = VendorId("siemens"),
            vendorPartNumber = VendorPartNumber("evidence.power-supply.24vdc"),
            displayName = "Siemens evidence 24V DC power supply",
            summary = "Narrow Siemens-first evidence implementation for the 24V DC power supply concept.",
        ),
    )
}
