...
- `_bmad-output/implementation-artifacts/1-5-execute-the-m0-compiler-as-declared-deterministic-passes.md` - current pass pipeline and downstream placeholder boundary.
...
- `_bmad-output/implementation-artifacts/1-6-derive-a-render-model-and-emit-simple-svg-from-engineering-ir.md`
