...
- The proof target is not â€œmore examplesâ€?in isolation. The proof target is a stable, rerunnable conformance contract over the real compiler path.
...
- `_bmad-output/implementation-artifacts/archive-m0/1-6-derive-a-render-model-and-emit-simple-svg-from-engineering-ir.md` - current render proof boundary and published SVG artifact.
...
- `_bmad-output/implementation-artifacts/archive-m0/1-7-publish-m0-conformance-examples-for-the-end-to-end-proof.md`
