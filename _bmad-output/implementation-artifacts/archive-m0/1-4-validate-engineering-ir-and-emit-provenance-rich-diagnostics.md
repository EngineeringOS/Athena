...
- The proof target is not â€œadd some checks.â€?The proof target is that semantic defects are detected only after lowering, inside one canonical semantic model, with enough evidence for a reviewer to understand what failed and why.
...
- `_bmad-output/implementation-artifacts/archive-m0/1-3-lower-parsed-intent-into-canonical-engineering-ir.md` - current IR boundary, duplicate fallback identity decision, and review-hardened lowering seam.
- `_bmad-output/implementation-artifacts/archive-m0/deferred-work.md` - pre-existing parser limitation deferred from Story `1.3`.
...
- `_bmad-output/implementation-artifacts/archive-m0/1-4-validate-engineering-ir-and-emit-provenance-rich-diagnostics.md`
