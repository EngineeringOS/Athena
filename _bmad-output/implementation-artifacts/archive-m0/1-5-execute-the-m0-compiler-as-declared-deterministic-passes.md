...
- `_bmad-output/implementation-artifacts/archive-m0/1-4-validate-engineering-ir-and-emit-provenance-rich-diagnostics.md` - continuation policy, compiler compile-path shape, and review-hardened semantic boundary.
...
- `_bmad-output/implementation-artifacts/archive-m0/1-5-execute-the-m0-compiler-as-declared-deterministic-passes.md`
