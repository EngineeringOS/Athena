...
- `_bmad-output/implementation-artifacts/archive-m0/1-2-author-and-parse-the-m0-electrical-runtime-dsl.md` - current AST boundary, example fixture, and unresolved review findings that may block lowering.
...
- `_bmad-output/implementation-artifacts/archive-m0/deferred-work.md`
- `_bmad-output/implementation-artifacts/archive-m0/1-3-lower-parsed-intent-into-canonical-engineering-ir.md`
