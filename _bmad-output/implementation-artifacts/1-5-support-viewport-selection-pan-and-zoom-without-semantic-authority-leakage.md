...
- `_bmad-output/implementation-artifacts/1-4-render-the-active-project-in-a-compose-semantic-viewer.md`
...
- `_bmad-output/implementation-artifacts/1-5-support-viewport-selection-pan-and-zoom-without-semantic-authority-leakage.md`
