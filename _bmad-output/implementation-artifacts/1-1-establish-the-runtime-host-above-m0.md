...
- Carry forward these established repo rules from `_bmad-output/implementation-artifacts/archive-m0/1-1-establish-the-m0-jvm-compiler-workspace.md`:
...
- `_bmad-output/implementation-artifacts/archive-m0/1-1-establish-the-m0-jvm-compiler-workspace.md`
