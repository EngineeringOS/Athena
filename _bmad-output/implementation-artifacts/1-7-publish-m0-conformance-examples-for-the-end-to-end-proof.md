...
- `_bmad-output/implementation-artifacts/1-6-derive-a-render-model-and-emit-simple-svg-from-engineering-ir.md` - current render proof boundary and published SVG artifact.
...
- `_bmad-output/implementation-artifacts/1-7-publish-m0-conformance-examples-for-the-end-to-end-proof.md`
