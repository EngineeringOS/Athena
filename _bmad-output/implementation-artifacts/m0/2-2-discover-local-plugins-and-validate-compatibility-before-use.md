...
- `_bmad-output/implementation-artifacts/m0/2-1-define-core-owned-typed-plugin-contracts.md` - previous story completion notes, verification evidence, and local implementation guardrails.
...
- `_bmad-output/implementation-artifacts/m0/2-2-discover-local-plugins-and-validate-compatibility-before-use.md`
