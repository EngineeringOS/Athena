...
- `_bmad-output/implementation-artifacts/m0/2-4-define-governed-knowledge-artifact-packages.md` - current governed knowledge package implementation, diagnostics, and explicit deferrals.
