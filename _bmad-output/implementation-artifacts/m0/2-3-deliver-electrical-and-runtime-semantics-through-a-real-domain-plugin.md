...
- `_bmad-output/implementation-artifacts/m0/2-1-define-core-owned-typed-plugin-contracts.md` - prior contract surface, validation vocabulary, and Story `2.1` non-goals.
- `_bmad-output/implementation-artifacts/m0/2-2-discover-local-plugins-and-validate-compatibility-before-use.md` - approved inventory model, discovery path, and Story `2.2` execution notes.
...
- `_bmad-output/implementation-artifacts/m0/2-3-deliver-electrical-and-runtime-semantics-through-a-real-domain-plugin.md`
