...
- [x] [Review][Patch] Preserve per-reference provenance in `EngineeringReference` [ir/src/main/kotlin/com/engineeringood/athena/ir/EngineeringModel.kt:64]
...
- `_bmad-output/implementation-artifacts/m0/1-2-author-and-parse-the-m0-electrical-runtime-dsl.md` - current AST boundary, example fixture, and unresolved review findings that may block lowering.
...
- `ir/src/main/kotlin/com/engineeringood/athena/ir/EngineeringModel.kt`
...
- `_bmad-output/implementation-artifacts/m0/deferred-work.md`
- `_bmad-output/implementation-artifacts/m0/1-3-lower-parsed-intent-into-canonical-engineering-ir.md`
