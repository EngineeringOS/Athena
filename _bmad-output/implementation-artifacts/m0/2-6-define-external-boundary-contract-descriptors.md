...
- `_bmad-output/implementation-artifacts/m0/2-5-resolve-governed-knowledge-artifacts-into-compilation-context.md` - prior story implementation, deferrals, and adjacency rules.
