...
- `_bmad-output/implementation-artifacts/m0/1-3-lower-parsed-intent-into-canonical-engineering-ir.md` - current IR boundary, duplicate fallback identity decision, and review-hardened lowering seam.
- `_bmad-output/implementation-artifacts/m0/deferred-work.md` - pre-existing parser limitation deferred from Story `1.3`.
...
- `_bmad-output/implementation-artifacts/m0/1-4-validate-engineering-ir-and-emit-provenance-rich-diagnostics.md`
