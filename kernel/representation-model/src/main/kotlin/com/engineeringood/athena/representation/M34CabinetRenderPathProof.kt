...
data class M34CabinetRenderPathProof(
    ...
    val accepted: Boolean
        get() = documentId.isNotBlank() &&
            ...
            rendererInputAuthority == DrawingProofAuthority.GRAPHIC_PRIMITIVE_IR.wireValue &&
            payloadAuthority == "typed-graphic-primitives" &&
            primitiveCount > 0 &&
            documentViewBoxAuthority == DrawingProofAuthority.GRAPHIC_PRIMITIVE_IR.wireValue &&
