...
class AthenaM27SampleProjectCompilerTest {
    ...
    private fun sampleProjectSources(): List<Path> {
        ...
        return listOf(
            repoRoot.resolve("examples/m27/sample-project/src/01-workspace-semantic-source.athena"),
            repoRoot.resolve("examples/m27/sample-project/src/02-field-assets-not-a-sheet.athena"),
        )
    }
