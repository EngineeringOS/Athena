    ...
    fun `compile reports duplicate connection keys as semantic uniqueness diagnostics`() {
        val duplicateSource = """
            system DuplicateConnections {
              ...
              connect plc1_out_to_plc1_out_3 PLC1.out to PLC1.out
              connect plc1_out_to_plc1_out_4 PLC1.out to PLC1.out
            }
        """.trimIndent()
    ...
    fun `synthesizes distinct fallback identities for duplicate declarations and repeated connections`() {
        val duplicateSource = """
            system DuplicateIdentity {
              ...
              connect plc1_out_to_plc1_out_5 PLC1.out to PLC1.out
              connect plc1_out_to_plc1_out_6 PLC1.out to PLC1.out
            }
        """.trimIndent()
