    ...
    private fun material(
        ...
        val definition = RepresentationDefinition(
            ...
            anatomy = PresentationAnatomy(
                representationId = com.engineeringood.athena.representation.RepresentationId("drive"),
                context = com.engineeringood.athena.representation.RepresentationContext.ELECTRICAL_SCHEMATIC,
                bounds = PresentationBounds(com.engineeringood.athena.representation.GridUnit(60), com.engineeringood.athena.representation.GridUnit(40)),
                hotspot = PresentationHotspot(PresentationPoint(com.engineeringood.athena.representation.GridUnit(0), com.engineeringood.athena.representation.GridUnit(0))),
            ...
            anchors = listOf(
                RepresentationAnchorContract(
                    ...
                    acceptedSignals = setOf(com.engineeringood.athena.representation.RepresentationSignalPredicate("power")),
                ),
            ),
        )
