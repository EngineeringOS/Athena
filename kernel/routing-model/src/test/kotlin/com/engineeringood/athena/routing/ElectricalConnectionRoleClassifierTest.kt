...
class ElectricalConnectionRoleClassifierTest {
    @Test
    fun `classifies digital output to input as control signal and preserves identities`() {
        ...
        val intent = ElectricalConnectionRoleClassifier().classify(
            sampleInput(
    ...
    fun `degrades unsupported signal and direction combinations explicitly`() {
        ...
        assertEquals(ElectricalConnectionRoleQualityState.DEGRADED, intent.quality.state)
    ...
    private fun sampleInput(
        ...
        return ElectricalConnectionRoleInput(
