...
`kernel` 鍒嗙粍鎵胯浇 Athena 鐨勮涔夐鏋躲€傝繖浜涙ā鍧楁嫢鏈変綔鑰呰瑷€杈圭晫銆佽鑼冨伐绋嬫ā鍨嬨€侀€氱敤鏍￠獙銆佺紪璇戝櫒缂栨帓銆乺untime 鎵樼锛屼互鍙婄‘瀹氭€х殑涓嬫父娓叉煋鑳藉姏銆?
## 妯″潡

- `:kernel:language` -> [`language/`](language/README.zh-CN.md)
- `kernel/plugins` 瀛愬垎缁?-> [`plugins/`](plugins/README.zh-CN.md)
...
Kernel 鎷ユ湁璇箟涓绘潈銆傛墿灞曘€乁I 涓庡簲鐢ㄥ彲浠ヤ緷璧栧畠锛屼絾涓嶅簲閲嶆柊瀹氫箟浣滆€呮簮銆佽鑼冩ā鍨嬶紝鎴栫紪璇戝櫒涓?runtime 鐨勬墍鏈夋潈瑙勫垯銆俙:kernel:plugins:plugin-api` 鏄潰鍚戞墿灞曠殑绋冲畾鍏叡 SPI锛宍:kernel:plugins:plugin-host` 鍒欐嫢鏈夊涓绘彃浠剁殑鏉ユ簮銆佸鎵逛笌宸叉壒鍑嗘竻鍗曟不鐞嗭紝骞朵笌缂栬瘧鍣ㄧ紪鎺掋€乺untime 缂栨帓淇濇寔鍒嗙銆?
