...
class LanguageFacadeBoundaryTest {
    ...
    fun `public contract package exposes exactly the intended facade allow-list`() {
        val expectedPublicTypeNames = setOf(
            ...
            "AthenaSourceUnit",
            "ProjectSourceUnit",
            "RepresentationSourceUnit",
            "KnowledgeSourceUnit",
            "KnowledgeDeclaration",
            "KnowledgeConceptDeclaration",
            "KnowledgePartDeclaration",
            "KnowledgeCapabilityDeclaration",
            "KnowledgeCapabilityDirection",
            "KnowledgeSubjectLevel",
            "KnowledgeParticipantRoleDeclaration",
            "KnowledgeRelationshipDeclaration",
            "KnowledgeFlowDeclaration",
            "KnowledgeDimensionDeclaration",
            "KnowledgeUnitDeclaration",
            "KnowledgeExpression",
            "KnowledgeBinaryOperator",
            "KnowledgeFunction",
            "KnowledgeComparisonOperator",
            "KnowledgeInterval",
            "KnowledgePredicate",
            "KnowledgeFormulaDeclaration",
            "KnowledgeConstraintDeclaration",
            "ImportDeclaration",
            "PackageDeclaration",
            "SystemDeclaration",
            "Declaration",
            ...
            "ParseFailure",
            "SyntaxDiagnostic",
            "AthenaSheetCompanionParser",
            "AthenaFolioCompanionParser",
            "SheetCompanionParseResult",
            "SheetCompanionParseSuccess",
            "SheetCompanionParseFailure",
            "SheetCompanionSource",
            "SheetPageIntent",
            "SheetOrientation",
            "SheetPlotFrameIntent",
            "SheetSnapIntent",
            "SheetTitleIntent",
            "SheetPoint",
            "SheetPlacementIntent",
            "SheetRouteConstraintIntent",
            "FolioCompanionSource",
            "FolioPageIntent",
            "FolioCompanionParseResult",
            "FolioCompanionParseSuccess",
            "FolioCompanionParseFailure",
            "FolioCompanionLocation",
            "FolioCompanionFound",
            "FolioCompanionMissing",
            "FolioCompanionAmbiguous",
            "FolioCompanionLocator",
            "PageCompanionLocation",
            "PageCompanionFound",
            "PageCompanionMissing",
            "PageCompanionAmbiguous",
            "PageCompanionLocator",
            "SheetStyleIntent",
            "SheetStyleAnnotationIntent",
            "SheetStyleCompanionSource",
            "SheetStyleCompanionParseResult",
            "SheetStyleCompanionParseSuccess",
            "SheetStyleCompanionParseFailure",
            "PageStyleCompanionLocator",
            "AthenaSheetStyleCompanionParser",
            "SheetStyleFields",
            "SheetStyleCompanionEditor",
            "SheetPlacementLockIntent",
            "SheetPlacementWrite",
            "SheetPlacementWriteResult",
            "SheetRouteConstraintWrite",
            "SheetRouteConstraintWriteResult",
            "SheetCompanionEditor",
            "ConnectionSourceKind",
            "ConnectionSourceEndpoint",
            "ConnectionSourceValue",
            "ConnectionSourceProperty",
            "ConnectionSourceInsertion",
            "ConnectionSourceReconnect",
            "ConnectionSourceEditResult",
            "ConnectionSourceEditor",
        )
