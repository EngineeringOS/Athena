...
- `renderer-benchmark-proof/src/com/engineeringood/rendererbenchmark/expansion-line.athena` - 比 M11 baseline 更大的电气源文件，用于验证连接可读性、viewport 行为，以及 repeated-reference reveal
